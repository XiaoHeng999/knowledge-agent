  ...
  return (
    <aside className="sidebar" aria-label="Sidebar">
      <div className="sidebar__search">
        <svg className="sidebar__search-icon" width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
      ...
      <div className="sidebar__actions">
        <button className="sidebar__action-btn" aria-label="Quick record">
          <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
            <path d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm3.5 7.5h-3v3h-1v-3h-3v-1h3v-3h1v3h3v1z" />
          </svg>
          <span>Quick Record</span>
        </button>
        <button className="sidebar__action-btn" aria-label="Settings">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
