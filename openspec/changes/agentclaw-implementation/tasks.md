...
- [ ] **5.2.1** 添加 ARIA 属性 — 所有自定义组件添加 aria-label、aria-describedby、role
- [ ] **5.2.2** 实现焦点管理 — 面板打开/关闭焦点转移、模态焦点陷阱
- [ ] **5.2.3** 实现键盘导航 — Tab/Shift+Tab 全应用导航、跳过导航链接
- [ ] **5.2.4** 实现 prefers-reduced-motion — 所有动画降级为即时状态变化
- [ ] **5.2.5** 验证颜色对比度 — 所有文本-背景组合满足 WCAG AA
- [ ] **5.2.6** 验证最小触控目标 — 所有交互元素 ≥ 32x32px
